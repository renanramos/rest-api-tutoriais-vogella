...
public class Test {
	...
	public static void main(String[] args){
		...
		String plainAnswer = 
				target.path("rest").path("hello").request().accept(MediaType.TEXT_PLAIN)
				.get(String.class);
		...
		String htmlAnswer = 
				target.path("rest").path("hello").request().accept(MediaType.TEXT_HTML)
				.get(String.class);
	
		System.out.print(response);
		System.out.print(plainAnswer);
		System.out.print(xmlAnswer);
		System.out.print(htmlAnswer);
	}
